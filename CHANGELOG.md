...
### Added
- **Party token cluster**: PF2e party tokens now have a Cluster Party button in Token Configuration. It builds a crowd-style token image from party member token art, saves it in the world folder, and applies it to the party actor and token.
